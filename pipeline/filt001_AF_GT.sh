...
#SBATCH --mem=100G
#SBATCH --time=2:00:00
#SBATCH --output=filt001_AF_GT.stdout
#SBATCH --job-name='filt001'
#SBATCH --array=1-16
...
bcftools view -i 'F_MISSING<0.5 & DP>0 & DP<445 & QUAL>30 & N_ALT=1 & AF < 1 & AF > 0' $SNPS/$FILE -o $FILTER/$NAME.minalt.vcf
